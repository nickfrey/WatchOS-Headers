...
- (void)crownInputSequencerDidBecomeIdle:(PUICCrownInputSequencer *)arg1 willDecelerate:(BOOL)arg2;
...
- (BOOL)crownInputSequencer:(PUICCrownInputSequencer *)arg1 shouldRubberBandAtBoundary:(int)arg2;
