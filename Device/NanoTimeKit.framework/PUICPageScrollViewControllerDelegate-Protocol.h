...
- (void)pageScrollViewController:(PUICPageScrollViewController *)arg1 didEndSwipeToDeleteAtIndex:(unsigned int)arg2 deleted:(BOOL)arg3;
...
- (BOOL)pageScrollViewController:(PUICPageScrollViewController *)arg1 canDeletePageAtIndex:(unsigned int)arg2;
- (void)pageScrollViewController:(PUICPageScrollViewController *)arg1 didSelectPageAtIndex:(unsigned int)arg2;
- (BOOL)pageScrollViewController:(PUICPageScrollViewController *)arg1 canSelectPageAtIndex:(unsigned int)arg2;
...
- (BOOL)pageScrollViewController:(PUICPageScrollViewController *)arg1 canMovePageAtIndex:(unsigned int)arg2;
@end
