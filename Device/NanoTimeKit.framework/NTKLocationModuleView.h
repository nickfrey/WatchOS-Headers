...
@interface NTKLocationModuleView : NTKComplicationModuleView <NTKLocationComplicationDisplay>
{
    NTKColoringLabel *_topLabel;
    NTKColoringLabel *_middleLabel;
    NTKColoringLabel *_bottomLabel;
}
