...
{
    BOOL _isStaticNotificationAlertItem;
...
@property(nonatomic) BOOL isStaticNotificationAlertItem; // @synthesize isStaticNotificationAlertItem=_isStaticNotificationAlertItem;
